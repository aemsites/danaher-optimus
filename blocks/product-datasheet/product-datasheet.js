...
import { div, h2, h6, p, a } from '../../scripts/dom-builder.js';
...
export default async function decorate(block) {
  ...
  const productKeyfacts = div({ class: 'grid grid-cols-[320px_minmax(auto,_1fr)] border-t-[2px] border-[#dde1e1] pt-10 mt-10 max-[799px]:grid-cols-1' },
  ...
  const productStorage = div({ class: 'grid grid-cols-[320px_minmax(auto,_1fr)] border-t-[2px] border-[#dde1e1] pt-10 mt-10 max-[799px]:grid-cols-1' },
    h2({ class: 'text-2xl font-semibold text-[#2a3c3c] mb-6' }, 'Storage'),
    div({ class: 'grid grid-cols-2 gap-x-3 gap-y-10' }, ...storageElements)
  );

  const productNotes = div({ class: 'grid grid-cols-[320px_minmax(auto,_1fr)] border-t-[2px] border-[#dde1e1] pt-10 mt-10 max-[799px]:grid-cols-1' },
    h2({ class: 'text-2xl font-semibold text-[#2a3c3c] mb-6' }, 'Notes'),
    dataNotes && div({ class: 'grid grid-cols-1' },
      p({ class: 'text-base text-black' }, `${dataNotes}`)
    )
  );

  const productPromise = div({ class: 'grid grid-cols-[320px_minmax(auto,_1fr)] border-t-[2px] border-[#dde1e1] pt-10 mt-10 max-[799px]:grid-cols-1' },
    ...
    div({ class: 'grid grid-cols-1' },
      div({ class: '' },
        ...
        p({ class: 'text-base text-black mb-4' }, 'Full details and terms and conditions can be found here: ',
