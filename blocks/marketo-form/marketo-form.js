...
async function loadMarketo(block) {
  ...
  const formName = tmpFormName?.firstElementChild?.nextElementSibling?.innerText.trim();
  ...
  console.log(tmpThankYou);
  console.log(thankYou);
  const formId = formName.replace('mktoform_', '');
  ...
  window.MktoForms2.loadForm('//439-KNJ-322.mktoweb.com', '439-KNJ-322', `${formId}`, (mktoform) => {
    ...
    console.log('actual form', formElement);
