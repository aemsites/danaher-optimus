...
export default async function buildAutoBlocks() {
  ...
  //   div(
  //     { class: 'protocol-header w-3/4 m-auto my-12 font-sans text-base flex flex-col justify-center' },
  //   ),
  // );
  ...
  breadcrumb.classList.add('block');
  breadcrumb.dataset.blockName = 'breadcrumb';
  //header.querySelector('.protocol-header')?.append(breadcrumb);
  //header.querySelector('.protocol-header')?.append(titleBlock);
  container.append(
    titleBlock,
  )
